...
export function Sidebar() {
  ...
  return (
    <aside className="w-52 shrink-0 bg-white dark:bg-slate-900 border-r border-[#e5eeff] dark:border-slate-700 sticky top-16 h-[calc(100vh-64px)] flex flex-col py-5 px-3 overflow-y-auto">
      <div className="mb-5 px-2">
        <p className="text-[#0058be] dark:text-cyan-300 font-semibold text-sm">Welcome back!</p>
        <p className="text-[#3d4a3d] dark:text-slate-300 text-xs mt-0.5 flex items-center gap-1">
